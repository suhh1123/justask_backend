package com.example.JustAsk.external;

import com.example.JustAsk.model.ExtractRequestBody;
import com.example.JustAsk.model.ExtractResponseItem;
import com.example.JustAsk.model.Extraction;
...
public class MonkeyLearnClient {
    ...
    private static final String AUTH_TAKEN = "af5e22c0250cf934f0dfcd84a2acda80523ddcf0";
    ...
    public List<Set<String>> extract(List<String> articles) {
        ...
        request.setHeader("Authorization", "Token "+AUTH_TAKEN);
